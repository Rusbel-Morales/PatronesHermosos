        ...
        <Drawer.Positioner>
          <Drawer.Content>
            ...
            <Drawer.Body>
              ...
              <Field.Root>
                <Field.Label>
                  Buscar por sede: <Field.RequiredIndicator />
                </Field.Label>
                <Input 
                  value={data.sede}
                  onChange={(e) => {
                ...
                />
                <Field.HelperText>Ej. PUE</Field.HelperText>
              </Field.Root>

              <Field.Root>
                <Field.Label>
                  Buscar por coordinadora: <Field.RequiredIndicator />
                </Field.Label>
                <Input 
                  value={data.nombre}
                  onChange={(e) => {
                ...
                />
                <Field.HelperText>Ej. Diego Gadiro Armando Rusbel</Field.HelperText>
              </Field.Root>
{/*
              <Field.Root>
                <Field.Label>
                ...
                <Portal>
                  <Select.Positioner>
                    <Select.Content zIndex="9998">
                      {stados.items.map((stados) => (
                        <Select.Item item={stados} key={stados.value}>
                          {stados.label}
                          <Select.ItemIndicator />
                        </Select.Item>
                      ))}
